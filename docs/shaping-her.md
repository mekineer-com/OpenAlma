...
**Declare the people in your life.** The SillyTavern extension has a Relationships section where you can name the people you talk about — family, friends, coworkers, pets. When she extracts memories from conversations that mention them, she can attribute things correctly rather than guessing who "my sister" is.
...
You can't write new memories into her store from nothing — the extraction process is the only path in, and that's intentional. A memory that comes from reading a real conversation is grounded in something; a typed-in fact isn't, and the system has no way to treat them differently.

You also can't force her to accept an identity you've written. If you leave the SillyTavern character card empty, she uses her own evolved self-model. If you fill it in, that takes precedence — but then she's who you wrote, not who she's become. Most people leave it empty.

## The balance

The system is designed to let you influence her without controlling her. She's not a blank slate you configure, and she's not a fixed character you can't touch. The relationship shapes her, and you're part of that relationship.
