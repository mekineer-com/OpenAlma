...
- Packaged repair, update, and uninstall require every OpenAlma service to be stopped, even when the launcher window is already closed. The installer refuses rather than force-killing a service or deleting around locked data.
